...
module.exports = {
  ...
  downloads: {
    storageDirectory: `${process.cwd()}/tmp`, // optional, the specific directory to store the flyway downloaded files. The directory must be writable by the node app process' user.
